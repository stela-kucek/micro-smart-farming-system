...
<!-- Page title -->
<title>MSFS Set Device Measurement</title>
		...
		<div class="container">
			...
			<div>
				<form:form method="POST"
					action="${pageContext.request.contextPath}/setMeasurement"
					...
					<div class="form-group">
						...
						<c:if test="${!entries.isEmpty()}">
							...
							<br>
							<div class="row ">
								<form:label path="chosenAction">Choose a measurement</form:label>
							</div>
							<div class="row ">
								<form:select path="chosenAction" class="form-control">
									<option value="Humidity">Soil Humidity</option>
									<option value="Acidity">Soil Acidity</option>
									<option value="Growth">Plant Growth</option>
								</form:select>
							</div>
							<br>
							<div class="row justify-content-md-center">
								<button type="submit" class="btn btn-primary">Measure</button>
							</div>
						</c:if>
