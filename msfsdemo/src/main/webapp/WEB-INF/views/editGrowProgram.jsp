...
<!-- Page title -->
<title>MSFS Edit Grow Program</title>
		...
		<div class="container">
			...
			<div>
				<form:form method="POST"
					action="${pageContext.request.contextPath}/updateGrowProgram"
					modelAttribute="gpForm">
					<form:input path="chosenProgram" type="hidden" value="${gpId}" />
					<div class="form-group">
						...
						<div class="row">
							<div class="col">
								...
								<form:input path="seedIrrigateHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="seedFertilizeHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<br><div class ="row justify-content-center"><i>Ideal conditions</i></div>
						
						<div class="row">
						
							<div class="col">
								<form:label path="seedHumidValue">Soil humidity (in %):</form:label>
								<form:input path="seedHumidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
							<div class="col">
								<form:label path="seedAcidValue">Soil acidity (in pH):</form:label>
								<form:input path="seedAcidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
						</div>
						...
						<div class="row">
							<div class="col">
								...
								<form:input path="seedlingIrrigateHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="seedlingHumidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
							<div class="col">
								<form:label path="seedlingAcidValue">Soil acidity (in pH):</form:label>
								<form:input path="seedlingAcidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
						</div>
						<br>
						...
						<div class="row">
							<div class="col">
								...
								<form:input path="youngIrrigateHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="youngFertilizeHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="youngHumidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
							<div class="col">
								<form:label path="youngAcidValue">Soil acidity (in pH):</form:label>
								<form:input path="youngAcidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
						</div>
						<br>
						...
						<div class="row">
							<div class="col">
								...
								<form:input path="adultIrrigateHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="adultFertilizeHowMuch" type="number" min="1" step="0.01"
									placeholder="e.g., 2" class="form-control"></form:input>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								...
								<form:input path="adultHumidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
							<div class="col">
								<form:label path="adultAcidValue">Soil acidity (in pH):</form:label>
								<form:input path="adultAcidValue" type="number" min="1.0" step="0.01"
									placeholder="e.g., 30" class="form-control"></form:input>
							</div>
						</div>
