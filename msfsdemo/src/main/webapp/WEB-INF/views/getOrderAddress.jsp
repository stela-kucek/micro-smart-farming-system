...
<!-- Page title -->
<title>MSFS Finalize Order</title>
		...
		<div class="container">
			...
			<div>
				<form:form method="POST"
					action="${pageContext.request.contextPath}/orderConfirmed"
					...
					<div class="form-group">
						...
						<div class="row">
							...
							<form:input path="street" type="text"
								placeholder="Enter street/HouseNum/DoorNum" class="form-control"></form:input>
						</div>
						<div class="row">
							<form:label path="zipCode">ZipCode:</form:label>
							<form:input path="zipCode" type="text"
								placeholder="Enter ZipCode" class="form-control"></form:input>
						</div>
						<div class="row">
							<form:label path="city">City:</form:label>
							<form:input path="city" type="text"
								placeholder="Enter City" class="form-control"></form:input>
						</div>
						<div class="row">
							<form:label path="country">Country:</form:label>
							<form:input path="country" type="text"
								placeholder="Enter Country" class="form-control"></form:input>
						</div>
