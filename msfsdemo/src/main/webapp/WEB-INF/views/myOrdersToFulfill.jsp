...
<!-- Page title -->
<title>MSFS My Orders to fulfill</title>
<style>
.failed {
	color: red;
}
			...
			<div class="title">
				...
				<sec:authorize access="isAuthenticated()">
					...
					<c:if test="${!orders.isEmpty()}">
						...
						<form:form name="MyOrdersToFulfill" method="GET"
							...
							<br>		
								<button type="submit" class="btn btn-danger" formmethod="GET"
										formaction="${pageContext.request.contextPath}/fulfillOrder">Fulfill Order</button>					
						</form:form>
